...
public static class Drawing
{
    ...
    public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width = 1, bool antiAlias = false)
    {
	...
	public static void PolyLine(Color color,float width, bool antiAlias, params Vector2[] points)
	{
